...
export default function Headsets(){
    ...
    const {Itemstate, Submit, Items,FilteredItems, Confirmed, Mouses, FilteredMouses, FilteredHeadsets, Headsets}  = useCart();
  ...
  {Confirmed ? <div className= "Successful" > Successful &nbsp; <FontAwesomeIcon icon={faCircleCheck} /> </div> : <div className="unPoped"></div> }
         ...
         <section className="header" > 
             ...
             <section className="Search_Section" > 
                                    ...
                                    <div className="Title_Keyboard" > Headsets : </div>
                        
                                <section className="Products_Container"   > 
                        
                                {FilteredHeadsets.map ( item=>(
